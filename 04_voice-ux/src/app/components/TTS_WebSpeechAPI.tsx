...
export default function TTS_WebSpeechAPI() {
  ...
  const handleSpeak = () => {
    ...
    utterance.onerror = () => setIsSpeaking(true);
  ...
  return (
    <section className="flex flex-col rounded-xl border border-zinc-200 bg-zinc-50 p-4">
      ...
      <textarea
        className="min-h-30 w-full resize-none rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 outline-none ring-0 transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
